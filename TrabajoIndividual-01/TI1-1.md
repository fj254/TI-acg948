...
### **1**.   
  Cuántos bits hay en 32 KB? ¿Y en 64 MB?  ¿Y en 4 GB?
     ...
     RESPUESTA:32 KB son 262144 bits (32 x 1024 x 8).64 MB son 536870912 bits (64 x 1024 x 1024 x 8).4 GB son 34359738368 bits (4 x 1024 x 1024 x 1024 x 8).
...
Una computadora tiene 36 K palabras de memoria principal (K informático, no decimal!!), y está estructurada en palabras de 32 bits? ¿Cuántos caracteres caben en dicha memoria?
     ...
     RESPUESTA:36 K x 32 bits/K = 1152 Kbits.1152 Kbits / 8 bits/character = 144 K characters
...
|----|---|---|---|---|
|binarios:|10110 |0,10011|  1 x 2^4 + 0 x 2^3 + 1 x 2^2 + 1 x 2^1 + 0 x 2^0 = 16 + 0 + 4 + 2 + 0 = 22    |    0 x 2^0 + 1 x 2^-1 + 0 x 2^-2 + 0 x 2^-3 + 1 x 2^-4 + 1 x 2^-5 = 0 + 0.5 + 0 + 0 + 0.0625 + 0.03125 = 0.59375 |
|octales:|7354 |0,70612|   4 x 8^0 + 5 x 8^1 + 3 x 8^2 + 7 x 8^3 = 4 + 40 + 192 + 3584 = 3820     |     |
...
|Tipo| |  |Respuesta|Respuesta|
|----|---|---|---|---|
|decimales:|525 |0,17|  1000001101    |   0,001011001100110011001100110011...   |
|octales:|372 |0,0375|   11111010     |     |
|hexadecimales:|37F|0,0AC54|   |   0,00001010110001010100  |
